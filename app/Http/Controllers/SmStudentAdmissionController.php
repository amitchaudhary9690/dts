...
class SmStudentAdmissionController extends Controller
{
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        $student->dob_np = date('Y-m-d', strtotime($request->dob_np));
    ...
    {
        try {
            $studentsArray = ['admission_number', 'roll_no', 'first_name', 'last_name', 'dob_np', 'date_of_birth', 'religion', 'gender', 'caste', 'mobile', 'email', 'admission_date', 'blood_group', 'height', 'weight', 'father_name', 'father_phone', 'father_occupation', 'mother_name', 'mother_phone', 'mother_occupation', 'guardian_name', 'guardian_relation', 'guardian_email', 'guardian_phone', 'guardian_occupation', 'guardian_address', 'current_address', 'permanent_address', 'bank_account_no', 'bank_name', 'national_identification_no', 'local_identification_no', 'previous_school_details', 'note'];
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    try {
                                        ...
                                        $student->dob_np = date('Y-m-d', strtotime($value->dob_np));
