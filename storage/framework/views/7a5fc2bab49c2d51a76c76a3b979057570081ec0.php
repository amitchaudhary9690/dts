...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->get('lang.exam'); ?></h1>
            <div class="bc-pages">
                <a href="<?php echo e(url('dashboard')); ?>"><?php echo app('translator')->get('lang.dashboard'); ?></a>
                <a href="#"><?php echo app('translator')->get('lang.examinations'); ?></a>
                <a href="#"><?php echo app('translator')->get('lang.exam'); ?></a>
            </div>
        </div>
    </div>
</section>
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <?php if(in_array(397, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
                                                    ...
                                                    <a class="dropdown-item"
                                                        href="<?php echo e(url('exam', $exam->id)); ?>"><?php echo app('translator')->get('lang.edit'); ?></a>
                                                 <?php endif; ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dts\resources\views/backEnd/examination/exam.blade.php ENDPATH**/ ?>