        ...
        <div class="card">
            ...
            <div class="single-report-admit">
                <div class="card-header">
                    <h2 class="text-center text-uppercase" style="color: whitesmoke">Welcome to Digital TechnoSoft Pvt. Ltd. </h2>
                
                </div>
            </div>

            <div class="card-body">
                  <h3 class="text-center text-success">Congratulations! Digital Academic ERP has been registered.</h3>
...
<?php /**PATH C:\xampp\htdocs\dts\resources\views/install/confirmation.blade.php ENDPATH**/ ?>