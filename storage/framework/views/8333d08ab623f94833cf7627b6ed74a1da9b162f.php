...
<nav id="sidebar">
    ...
    <div class="sidebar-header update_sidebar">
        ...
        <a id="close_sidebar" class="d-none">
            <i class="ti-close"></i>
        </a>
    </div>
        ...
        <?php else: ?>
            ...
            <?php if(Auth::user()->role_id != 2 && Auth::user()->role_id != 3): ?>
                    ...
                    <li>
                        ...
                        <ul class="collapse list-unstyled" id="subMenuAcademic">
                            ...
                            <?php if(@in_array(253, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(url('assign-class-teacher')); ?>">
                                        <?php echo app('translator')->get('lang.assign_class_teacher'); ?></a>
                                </li>
                            <?php endif; ?>
                    ...
                    <li>
                        ...
                        <ul class="collapse list-unstyled" id="subMenusystemReports">
                            ...
                            <?php if(@in_array(382, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a
                                        href="<?php echo e(route('balance_fees_report')); ?>"><?php echo app('translator')->get('lang.balance_fees_report'); ?></a>
                                </li>
                            <?php endif; ?>
                            ...
                            <?php if(@in_array(393, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a
                                        href="<?php echo e(route('student_fine_report')); ?>"><?php echo app('translator')->get('lang.student_fine_report'); ?></a>
                                </li>
                            <?php endif; ?>
                            ...
                            <?php if(@in_array(540, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(url('previous-record')); ?>"><?php echo app('translator')->get('lang.previous'); ?>
                                        <?php echo app('translator')->get('lang.record'); ?>
                                    </a>
                                </li>
                            <?php endif; ?>
                ...
                <?php if(@in_array(398, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                    <li>
                        <a href="#subMenuIdcardcertificate" data-toggle="collapse" aria-expanded="false"
                            class="dropdown-toggle">
                            <span class="flaticon-analysis"></span>
                            <?php echo app('translator')->get("lang.id_card_certificate"); ?>
                        </a>
                        <ul class="collapse list-unstyled" id="subMenuIdcardcertificate">
                    ...
                    <li>
                        ...
                        <ul class="collapse list-unstyled" id="subMenusystemSettings">
                            ...
                            <?php if(App\SmGeneralSettings::isModule('Saas') == true): ?>
                                <li>
                                    <a href="<?php echo e(url('school-general-settings')); ?>">
                                        <?php echo app('translator')->get('lang.general_settings'); ?></a>
                                </li>
                            <?php else: ?>
                        ...
                        <li>
                            ...
                            <ul class="collapse list-unstyled" id="subMenusystemStyle">
                                ...
                                <?php if(in_array(490, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                    <li>
                                        <a href="<?php echo e(url('color-style')); ?>"><?php echo app('translator')->get('lang.color'); ?>
                                            <?php echo app('translator')->get('lang.theme'); ?></a>
                                    </li>
                                <?php endif; ?>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="collapse list-unstyled" id="subMenufrontEndSettings">
                                ...
                                <?php if(@in_array(525, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                    <li>
                                        <a
                                            href="<?php echo e(url('course-heading-update')); ?>"><?php echo app('translator')->get('lang.course_heading'); ?></a>
                                    </li>
                                <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\dts\resources\views/backEnd/partials/sidebar.blade.php ENDPATH**/ ?>