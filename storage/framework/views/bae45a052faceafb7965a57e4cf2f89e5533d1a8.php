        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <div class="row">
                    ...
                    <span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Disabled Images <?php echo app('translator')->get('lang.backup'); ?>">
                            <button class="primary-btn small fix-gr-bg  demo_view" style="pointer-events: none;" type="button" >Images <?php echo app('translator')->get('lang.backup'); ?></button>
                          </span>
                              <span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Disabled Full Project <?php echo app('translator')->get('lang.backup'); ?>">
                          ...
                          <span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Disabled Database <?php echo app('translator')->get('lang.backup'); ?>">
                    ...
                    <?php else: ?>
                        ...
                        <?php if(in_array(462, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
                             <a href="<?php echo e(url('get-backup-db')); ?>" class="primary-btn small fix-gr-bg demo_view"> <span class="ti-arrow-circle-down pr-2"></span> Database <?php echo app('translator')->get('lang.backup'); ?> </a>
                        <?php endif; ?> 
                <?php endif; ?> 
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dts\resources\views/backEnd/systemSettings/backupSettings.blade.php ENDPATH**/ ?>