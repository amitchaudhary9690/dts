...
<?php
    ...
    if (isset($setting->copyright_text)) {
        ...
        $copyright_text = 'Copyright © 2019 All rights reserved | This application is made with by Digital TechnoSoft Pvt. Ltd.';
    }
    ...
    if (isset($setting->site_title) && !empty($setting->site_title)) {
        ...
        $site_title = 'Digital Academic ERP';
    }
...
<?php /**PATH C:\xampp\htdocs\dts\resources\views/frontEnd/home/front_master.blade.php ENDPATH**/ ?>