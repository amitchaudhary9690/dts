...
<head>
    ...
    <title>eSkooly Educational ERP</title>
            ...
            <div class="card-body">
               ...
               <form method="post" action="<?php echo e(url('check-verified-input')); ?>">
                   ...
                   <div class="form-group">
                       ...
                       <input type="text" class="form-control" id="key" name="purchasecode" onchange="checkKeyStatus()" required="required" placeholder="Enter Your eSkooly Purchase Key">
...
<?php /**PATH C:\xampp\htdocs\pro\resources\views/install/check_purchase_page.blade.php ENDPATH**/ ?>