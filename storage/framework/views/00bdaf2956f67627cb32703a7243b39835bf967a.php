                        ...
                        <div class="row mb-40">
                            ...
                            <div class="col-lg-2">
                                <div class="no-gutters input-right-icon">
                                    <div class="col">
                                        <div class="input-effect sm2_mb_20 md_mb_20">
                                            <input class="primary-input nepali-datepicker form-control<?php echo e($errors->has('dob_np') ? ' is-invalid' : ''); ?>" id="nepali-datepicker" type="text"
                                                name="dob_np" value="<?php echo e(old('dob_np')); ?>" autocomplete="off">
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dts\resources\views/backEnd/studentInformation/student_admission.blade.php ENDPATH**/ ?>