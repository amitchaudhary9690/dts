...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/backEnd/css/nepdate.css')); ?>">
                        ...
                        <div class="row mb-20">
                            ...
                            <div class="col-lg-2">
                                <div class="no-gutters input-right-icon">
                                    <div class="col">
                                        <div class="input-effect">
                                            <input class="primary-input nepali-datepicker form-control<?php echo e($errors->has('dob_np') ? ' is-invalid' : ''); ?>" id="nepali-datepicker" type="text" name="dob_np" value="<?php echo e(date('Y/m/d', strtotime($student->dob_np))); ?>" autocomplete="off">
                                            <span class="focus-border"></span>
                                            <label><?php echo app('translator')->get('lang.date_of_birth'); ?> <span>*</span></label>
                                            <?php if($errors->has('dob_np')): ?>
                                    <span class="invalid-feedback" role="alert">
                                        <strong><?php echo e($errors->first('dob_np')); ?></strong>
                                    </span>
                                    <?php endif; ?>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-2">
                                <div class="no-gutters input-right-icon">
                                    <div class="col">
                                        <div class="input-effect">
                                            <input class="primary-input date form-control<?php echo e($errors->has('date_of_birth') ? ' is-invalid' : ''); ?>" id="startDate" type="text" name="date_of_birth" value="<?php echo e(date('Y/m/d', strtotime($student->date_of_birth))); ?>" autocomplete="off">
                                            <span class="focus-border"></span>
                                            <label><?php echo app('translator')->get('lang.date_of_birth'); ?> <span>*</span></label>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12 text-center mt-40">
                                                        <div class="mt-40 d-flex justify-content-between">
                                                            ...
                                                            <button class="primary-btn fix-gr-bg" id="save_button_parent" data-dismiss="modal" type="button"><?php echo app('translator')->get('update_information'); ?></button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
                            ...
                            <div class="col-lg-3">
                                <div class="input-effect" id="roomNumberDiv">
                                    <select class="niceSelect w-100 bb form-control<?php echo e($errors->has('room_number') ? ' is-invalid' : ''); ?>" name="room_number" id="selectRoomNumber">
                                        <option data-display="<?php echo app('translator')->get('lang.room'); ?> <?php echo app('translator')->get('lang.name'); ?>" value=""><?php echo app('translator')->get('lang.room'); ?> <?php echo app('translator')->get('lang.name'); ?></option>
...
<script src="<?php echo e(asset('public/backEnd/js/nepali_datepicker.js')); ?>"></script>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dts\resources\views/backEnd/studentInformation/student_edit.blade.php ENDPATH**/ ?>