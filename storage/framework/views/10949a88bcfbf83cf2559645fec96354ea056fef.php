                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    <select
                                        class="niceSelect w-100 bb form-control<?php echo e($errors->has('academic_year') ? ' is-invalid' : ''); ?>"
                                        name="academic_year" id="academic_year">
                                        <option data-display="<?php echo app('translator')->get('lang.academic_year'); ?> *" value="">
                                            <?php echo app('translator')->get('lang.academic_year'); ?> *</option>
                            ...
                            <div class="col-lg-3 sm_mb_20 sm2_mb_20 md_mb_20" id="class-div">
                                <select
                                    ...
                                    <option data-display="<?php echo app('translator')->get('lang.select'); ?> <?php echo app('translator')->get('lang.class'); ?> *" value="">
                                        <?php echo app('translator')->get('lang.select'); ?> <?php echo app('translator')->get('lang.class'); ?></option>
                            ...
                            <div class="col-lg-2 col-md-3" id="sectionStudentDiv">
                                <select
                                    ...
                                    <option data-display="<?php echo app('translator')->get('lang.select_section'); ?>" value="">
                                        <?php echo app('translator')->get('lang.select_section'); ?></option>
                                </select>
                        ...
                        <div class="row">
                            <div class="col-lg-4 no-gutters">
                                <div class="main-title">
                                    <h3 class="mb-0"><?php echo app('translator')->get('lang.student_list'); ?>
                                        (<?php echo e(@$students ? @$students->count() : 0); ?>)</h3>
                                </div>
                            </div>
                        </div>
                        <div class="row  ">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = @$students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><?php echo e(!empty($student->className) ? $student->className->class_name : ''); ?>

                                                </td>

                                                <td><?php echo e(!empty($student->parents->fathers_name) ? $student->parents->fathers_name : ''); ?>

                                                </td>
                                                <td data-sort="<?php echo e(strtotime($student->dob_np)); ?>">

                                                    <?php echo e($student->dob_np != '' ? $student->dob_np : ''); ?>
                                                ...
                                                <td><?php echo e($student->gender != '' ? $student->gender->base_setup_name : ''); ?>
                                                ...
                                                <td class="pull-right">
                                                    <a class="fa fa-rupee"
                                                        href="<?php echo e(route('fees_collect_student_wise', [$student->id])); ?>">
                                                        
                                                    </a>

                                                    <a class="ti-menu"
                                                        href="<?php echo e(route('student_view', [$student->id])); ?>">
                                                        
                                                    </a>

                                                    <?php if(in_array(66, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                                        <a class="ti-pencil-alt"
                                                            href="<?php echo e(route('student_edit', [$student->id])); ?>">
                                                    ...
                                                    <?php if(in_array(67, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                                        ...
                                                        <?php if(Illuminate\Support\Facades\Config::get('app.app_sync')): ?>
                                                            <span data-toggle="tooltip" title="Disabled For Demo ">
                                                                <a class="ti-trash-ti" href="#" data-toggle="modal"
                                                                    data-target="#deleteStudentModal" data-id="">
                                                        ...
                                                        <?php else: ?>
                                                            <a onclick="deleteId(<?php echo e($student->id); ?>);" class="ti-trash"
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dts\resources\views/backEnd/studentInformation/student_details.blade.php ENDPATH**/ ?>