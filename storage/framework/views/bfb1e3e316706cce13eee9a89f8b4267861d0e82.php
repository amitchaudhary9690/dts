                                ...
                                <div class="add-visitor">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="input-effect">
                                                <input
                                                    class="primary-input form-control<?php echo e(@$errors->has('subject_name') ? ' is-invalid' : ''); ?>"
                                    ...
                                    <div class="row  mt-40">
                                        <div class="col-lg-12">
                                            <div class="input-effect">
                                                <input
                                                    class="primary-input form-control<?php echo e($errors->has('subject_code') ? ' is-invalid' : ''); ?>"
                                    ...
                                    <div class="row  mt-40">
                                        <div class="col-lg-12">
                                            <div class="input-effect">
                                                <input
                                                    class="primary-input form-control<?php echo e($errors->has('credit_hours') ? ' is-invalid' : ''); ?>"
                                                    type="text" name="credit_hours" autocomplete="off"
                                                    value="<?php echo e(isset($subject) ? $subject->credit_hours : old('credit_hours')); ?>">
                                                <label><?php echo app('translator')->get('lang.credit_hours'); ?></label>
                                                <span class="focus-border"></span>
                                                <?php if($errors->has('credit_hours')): ?>
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong><?php echo e(@$errors->first('credit_hours')); ?></strong>
                                                    </span>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                            ...
                            <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                                ...
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th><?php echo app('translator')->get('lang.credit_hours'); ?></th>
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <?php if(in_array(259, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                                            <a class="dropdown-item"
                                                                href="<?php echo e(route('subject_edit', [@$subject->id])); ?>"><?php echo app('translator')->get('lang.edit'); ?></a>
                                                        <?php endif; ?>
                                                        <?php if(in_array(260, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                                            <a class="dropdown-item" data-toggle="modal"
                                                                data-target="#deleteSubjectModal<?php echo e(@$subject->id); ?>"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title"><?php echo app('translator')->get('lang.delete'); ?> <?php echo app('translator')->get('lang.subject'); ?>
                                                        </h4>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dts\resources\views/backEnd/academics/subject.blade.php ENDPATH**/ ?>