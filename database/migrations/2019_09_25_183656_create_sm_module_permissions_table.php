...
$table->integer('created_by')->nullable()->default(1)->unsigned();
        ...
        $modules = ['Dashboard', 'Admin Section', 'Student Information', 'Teacher', 'Fees Collection', 'Accounts', 'Human resource', 'Leave Application', 'Examination', 'Academics', 'HomeWork', 'Communicate', 'Library', 'Inventory', 'Transport', 'Dormitory', 'Reports', 'System Settings', 'Common', 'ID Card Certificate'];
        ...
        (22, 1, 'ID Card Certificate', 1, 1, 1, 1, '2019-07-25 02:21:21', '2019-07-25 04:24:22'),
