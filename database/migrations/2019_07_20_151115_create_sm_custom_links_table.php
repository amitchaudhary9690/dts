...
class CreateSmCustomLinksTable extends Migration
{
    ...
    public function up()
    {
        ...
        $s->link_href1  = 'https://pro.eskooly.com';

        $s->link_label2 = 'eSkooly Home';
        $s->link_href2  = 'https://pro.eskooly.com';

        $s->link_label3 = 'Business';
        $s->link_href3  = 'https://pro.eskooly.com';

        $s->link_label4 = 'link_label4';
        $s->link_href4  = 'https://pro.eskooly.com';

        $s->link_label5 = 'link_label5';
        $s->link_href5  = 'https://pro.eskooly.com';

        $s->link_label6 = 'link_label6';
        $s->link_href6  = 'https://pro.eskooly.com';

        $s->link_label7 = 'link_label7';
        $s->link_href7  = 'https://pro.eskooly.com';

        $s->link_label8 = 'link_label8';
        $s->link_href8  = 'https://pro.eskooly.com';

        $s->link_label9  = 'Home';
        $s->link_href9   = 'https://pro.eskooly.com';

        $s->link_label10 = 'About';
        $s->link_href10  = 'https://pro.eskooly.com';


        $s->link_label11 = 'Contact';
        $s->link_href11  = 'https://pro.eskooly.com';

        $s->link_label12 = 'link_label12';
        $s->link_href12  = 'https://pro.eskooly.com';

        $s->link_label13 = 'link_label13';
        $s->link_href13  = 'https://pro.eskooly.com';

        $s->link_label14 = 'link_label14';
        $s->link_href14  = 'https://pro.eskooly.com';

        $s->link_label15 = 'link_label15';
        $s->link_href15  = 'https://pro.eskooly.com';

        $s->link_label16 = 'link_label16';
        $s->link_href16  = 'https://pro.eskooly.com';
