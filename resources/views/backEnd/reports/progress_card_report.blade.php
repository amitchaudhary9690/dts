                                            ...
                                            <div class="card-header">
                                                    <div class="d-flex">
                                                            ...
                                                            <div class="col-lg-6 ml-30">
                                                                <h3 class="text-white"> {{isset($school_name)?$school_name:'Digital Academic ERP'}} </h3> 
                                                                <p class="text-white mb-0"> {{isset($address)?$address:'Jeetpursimara-02, Simara'}} </p>
                                                                <p class="text-white mb-0">Email:  {{isset($email)?$email:'info@digitaltechnosoft.com.np'}} ,   Phone:  {{isset($phone)?$phone:'admin@demo.com'}} </p> 
                                                            </div>
                                                            <div class="offset-2">
