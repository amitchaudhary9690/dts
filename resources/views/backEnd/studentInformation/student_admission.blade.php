                        ...
                        <div class="row mb-40">
                            ...
                            <div class="col-lg-2">
                                <div class="no-gutters input-right-icon">
                                    <div class="col">
                                        <div class="input-effect sm2_mb_20 md_mb_20">
                                            <input class="primary-input nepali-datepicker form-control{{ $errors->has('dob_np') ? ' is-invalid' : '' }}" id="nepali-datepicker" type="text"
                                                name="dob_np" value="{{old('dob_np')}}" autocomplete="off">
