...
<link rel="stylesheet" type="text/css" href="{{ asset('public/backEnd/css/nepdate.css') }}">
                        ...
                        <div class="row mb-20">
                            ...
                            <div class="col-lg-2">
                                <div class="no-gutters input-right-icon">
                                    <div class="col">
                                        <div class="input-effect">
                                            <input class="primary-input nepali-datepicker form-control{{ $errors->has('dob_np') ? ' is-invalid' : '' }}" id="nepali-datepicker" type="text" name="dob_np" value="{{date('Y/m/d', strtotime($student->dob_np))}}" autocomplete="off">
                                            <span class="focus-border"></span>
                                            <label>@lang('lang.date_of_birth') <span>*</span></label>
                                            @if ($errors->has('dob_np'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('dob_np') }}</strong>
                                    </span>
                                    @endif
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-2">
                                <div class="no-gutters input-right-icon">
                                    <div class="col">
                                        <div class="input-effect">
                                            <input class="primary-input date form-control{{ $errors->has('date_of_birth') ? ' is-invalid' : '' }}" id="startDate" type="text" name="date_of_birth" value="{{date('Y/m/d', strtotime($student->date_of_birth))}}" autocomplete="off">
                                            <span class="focus-border"></span>
                                            <label>@lang('lang.date_of_birth') <span>*</span></label>
...
<script src="{{ asset('public/backEnd/js/nepali_datepicker.js') }}"></script>
    {{-- <script src="http://nepalidatepicker.sajanmaharjan.com.np/nepali.datepicker/js/nepali.datepicker.v3.5.min.js"
