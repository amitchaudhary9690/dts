                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    <select
                                        class="niceSelect w-100 bb form-control{{ $errors->has('academic_year') ? ' is-invalid' : '' }}"
                                        name="academic_year" id="academic_year">
                                        <option data-display="@lang('lang.academic_year') *" value="">
                                            @lang('lang.academic_year') *</option>
                            ...
                            <div class="col-lg-3 sm_mb_20 sm2_mb_20 md_mb_20" id="class-div">
                                <select
                                    ...
                                    <option data-display="@lang('lang.select') @lang('lang.class') *" value="">
                                        @lang('lang.select') @lang('lang.class')</option>
                            ...
                            <div class="col-lg-2 col-md-3" id="sectionStudentDiv">
                                <select
                                    ...
                                    <option data-display="@lang('lang.select_section')" value="">
                                        @lang('lang.select_section')</option>
                                </select>
                        ...
                        <div class="row">
                            <div class="col-lg-4 no-gutters">
                                <div class="main-title">
                                    <h3 class="mb-0">@lang('lang.student_list')
                                        ({{ @$students ? @$students->count() : 0 }})</h3>
                                </div>
                            </div>
                        </div>
                        <div class="row  ">
                                    ...
                                    <tbody>
                                        @foreach (@$students as $student)
                                            <tr>
                                                ...
                                                <td>{{ !empty($student->className) ? $student->className->class_name : '' }}
                                                </td>

                                                <td>{{ !empty($student->parents->fathers_name) ? $student->parents->fathers_name : '' }}
                                                </td>
                                                <td data-sort="{{ strtotime($student->dob_np) }}">

                                                    {{ $student->dob_np != '' ? $student->dob_np : '' }}
                                                ...
                                                {{-- <td>{{ !empty($student->category) ? $student->category->category_name : '' }} --}}
                                                </td>
                                                <td>{{ $student->mobile }}</td>
                                                <td class="pull-right">
                                                    <a class="fa fa-rupee"
                                                        href="{{ route('fees_collect_student_wise', [$student->id]) }}">
                                                        {{-- @lang('lang.student_wise') --}}
                                                    </a>

                                                    <a class="ti-menu"
                                                        href="{{ route('student_view', [$student->id]) }}">
                                                        {{-- @lang('lang.view') --}}
                                                    </a>

                                                    @if (in_array(66, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1)
                                                        <a class="ti-pencil-alt"
                                                            href="{{ route('student_edit', [$student->id]) }}">
                                                            {{-- @lang('lang.edit') --}}
                                                        </a>
                                                    @endif
                                                    ...
                                                    @if (in_array(67, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1)
                                                        ...
                                                        @else
                                                            <a onclick="deleteId({{ $student->id }});" class="ti-trash"
                                            ...
                                            <div class="dropdown">
                                                ...
                                                @endif
                                                 ...
                                                 @endif
                                                    ...
                                                    @endif
                                                    <a class="dropdown-item" href="{{route('fees_collect_student_wise', [$student->id])}}">@lang('lang.student_wise')</a>
                                                </div>
                                            </div>
                                        </td> --}}
                                            </tr>
