                                ...
                                <div class="add-visitor">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="input-effect">
                                                <input
                                                    class="primary-input form-control{{ @$errors->has('subject_name') ? ' is-invalid' : '' }}"
                                    ...
                                    <div class="row  mt-40">
                                        <div class="col-lg-12">
                                            <div class="input-effect">
                                                <input
                                                    class="primary-input form-control{{ $errors->has('subject_code') ? ' is-invalid' : '' }}"
                                    ...
                                    <div class="row  mt-40">
                                        <div class="col-lg-12">
                                            <div class="input-effect">
                                                <input
                                                    class="primary-input form-control{{ $errors->has('credit_hours') ? ' is-invalid' : '' }}"
                                                    type="text" name="credit_hours" autocomplete="off"
                                                    value="{{ isset($subject) ? $subject->credit_hours : old('credit_hours') }}">
                                                <label>@lang('lang.credit_hours')</label>
                                                <span class="focus-border"></span>
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        @if (in_array(259, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1)
                                                            <a class="dropdown-item"
                                                                href="{{ route('subject_edit', [@$subject->id]) }}">@lang('lang.edit')</a>
                                                        @endif
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title">@lang('lang.delete') @lang('lang.subject')
                                                        </h4>
