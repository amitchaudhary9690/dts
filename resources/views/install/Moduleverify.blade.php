...
<head>
    ...
    <title>Digital Academic ERP | Verify Your purchase {{@$name}} Module</title>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="justify-content-center">
                    <p class=" text-red purchase-alert">If you are using {{@$name}} Module without purchase, Please contact with us at <a target="_blank" href="mailto:info@digitaltechnosoft.com.np">info@digitaltechnosoft.com.np</a>.</p>
                    ...
                    <form method="POST" action="{{url('module-verify-purchase')}}" class="mt-40">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control " name="envatouser"  required="required"  placeholder="Enter Your Registered Email" value="{{old('envatouser')}}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="purchasecode" required="required" placeholder="Enter Your Serial Key" value="{{old('purchasecode')}}">
                        </div>
                        <div class="form-group">
